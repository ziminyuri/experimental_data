...
class Ui_add_graph(object):
    def __init__(self, main_window):
        ...
        self.add_grpah_window = main_window.add_graph_window

        self.add_grpah_window.setObjectName("add_graph")
        self.add_grpah_window.setFixedSize(613, 437)
        #self.add_grpah_window.setAutoFillBackground(False)

        self.centralwidget = QtWidgets.QWidget(self.add_grpah_window)
        ...
        self.pushButton.clicked.connect(self.add_graph)

        self.add_grpah_window.setCentralWidget(self.centralwidget)
        self.statusbar = QtWidgets.QStatusBar(self.add_grpah_window)
        self.statusbar.setObjectName("statusbar")
        self.add_grpah_window.setStatusBar(self.statusbar)

        self.retranslateUi(self.add_grpah_window)
        QtCore.QMetaObject.connectSlotsByName(self.add_grpah_window)
